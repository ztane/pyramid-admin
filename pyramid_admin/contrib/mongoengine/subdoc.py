...
from pyramid_admin.model.form import InlineBaseFormAdmin
...
def convert_subdocuments(values):
    ...
    for name, p in iteritems(values):
        if isinstance(p, dict):
            ...
            raise ValueError('Invalid subdocument type: expecting dict or instance of pyramid_admin.contrib.mongoengine.EmbeddedForm, got %s' % type(p))
