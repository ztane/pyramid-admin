...
from pyramid_admin import __version__
...
html_sidebars = {
    'index': ['sidebarintro.jinja2', 'sourcelink.jinja2', 'searchbox.jinja2'],
    '**': ['localtoc.jinja2', 'relations.jinja2',
           'sourcelink.jinja2', 'searchbox.jinja2']
}
